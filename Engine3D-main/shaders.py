...
import random
from gl import _color


def inverseColors(render, **kwargs):
    ...
    intensity = ml.dotProduct(normal, render.directional_light)
...
def wire(render, **kwargs):
   #Iluminacion por pixel
    u, v, w = kwargs['baryCoords']
    cColor = kwargs['cColor']
    b, g, r = kwargs['color']

    wireColor = _color(1,1,1)
